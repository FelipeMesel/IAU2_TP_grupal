...
Para ello, comenzaremos por visualizar nuestros datos con  **gráficos de distribución** con regresión lineal, **gráficos de barras** y **mapas de densidad**.  
...
```{r}
#AGREGAR BARRIO EN HOSPITALES Y FILTRAR TODO POR PUERTO MADERO Y LUGANO
...
establecimientos_educativos <- read_sf("data/establecimientos_educativos.geojson") %>% 
                               select(nombre_est, nivel=nivelmodal, dom_edific, barrio)

#BUSCAR OBSERVACIONES CON ERRORES EN LA GEOMETRIA

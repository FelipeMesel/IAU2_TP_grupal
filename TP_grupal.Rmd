...
Nos propusimos trabajar con dos bases de datos de Properati, correspondientes al año 2021 -encontramos datos que van de marzo del 2021 hasta el presente-, relativos a la **oferta de inmuebles en venta y alquiler en la Ciudad de Buenos Aires**, a los fines de analizar la gradiente de precios del suelo en la ciudad.
...
ggplot() + 
 ...
 labs(title = "Mapa 3.Precio, localización y transporte",
         subtitle = "La importancia de la localización en el precio de los inmuebles de la CABA: subteráneo",
         fill = "Precio promedio (U$D/m2)",
         caption= "Fuente: Properati - 2021") +
  scale_fill_distiller(palette = "Spectral") +
...
ggplot() + 
 ...
 labs(title = "Mapa 4.Precio, localización y transporte",
         subtitle = "La importancia de la localización en el precio de los inmuebles de la CABA: subterráneo, metrobús y ferrocarril",
         fill = "Precio promedio (U$D/m2)",
         caption= "Fuente: Properati - 2021") +
  scale_fill_distiller(palette = "Spectral") +
...
establecimientos_educativos <-  establecimientos_educativos %>% 
                                filter(comuna == "8" | 
                                      ...
                                      !str_starts( establecimientos_educativos$nivel, "Nivel Secundario"),
